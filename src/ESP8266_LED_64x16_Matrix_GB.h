...
#ifndef ESP8266_LED_64x16_Matrix_GB_h
#define ESP8266_LED_64x16_Matrix_GB_h
...
private:
	...
	//this is for the gb font for displayed character
	uint8_t extraFontStart = 96;
	uint8_t extraFontTotal = 100;
	uint8_t font8x16_extra[1600];
